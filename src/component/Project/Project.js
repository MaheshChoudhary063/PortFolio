      ...
      <div>
        <section id="project">
          ...
          <span className="projectP">
            Redundant alt attribute. Screen-readers already announce `img` tags
            as an image. You don’t need to use the words `image`
          </span>
          <div className="projectDiv">
            <div className="projectt">
              ...
              <h1>Nova</h1>
              <p>
                The e-commerce website is developed by mern stack
                <br /> user-friendly product management.{" "}
              </p>
              <a
            ...
            <div className="projectt">
              ...
              <h1>FormCraft </h1>
              <p>
                FormCraft is a web application developed using the MERN
                <br /> makes interacting with forms, responses, and user{" "}
              </p>
              <a
                href="https://github.com/MaheshChoudhary063/FormCraft"
                target="_blank"
                rel="noopener noreferrer"
              >
                <button className="projectB">See Project</button>{" "}
            ...
            <div className="projectt">
              ...
              <h1>ChatFill</h1>
              <p>
                ChatFill developed with Node.js and Socket.io. <br /> Enable
                users to create and join group chats.
              </p>
              <a
